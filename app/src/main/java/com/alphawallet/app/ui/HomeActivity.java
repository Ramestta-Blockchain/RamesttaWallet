        ...
        FragmentMessenger, Runnable, SignAuthenticationCallback, ActionSheetCallback, LifecycleObserver, PagerCallback
{
    ...
    {
        Timber.tag("LIFE").d("RamesttaWallet  into foreground");
        if (viewModel != null)
        {
    ...
    {
        Timber.tag("LIFE").d("RamesttaWallet  into background");
    ...
    private void checkWarnings()
    {
        if (updatePrompt)
        {
            ...
            if (warns < 3)
            {
                ...
                cDialog.setSmallText("Using an old version of Alphawallet. Please update from the Play Store or RamesttaWallet  website.");
