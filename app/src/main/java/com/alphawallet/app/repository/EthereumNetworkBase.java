...
public abstract class EthereumNetworkBase implements EthereumNetworkRepositoryType
{
    ...
    /* constructing URLs from BuildConfig. In the below area you will see hardcoded key like da3717...
       These hardcoded keys are fallbacks used by RamesttaWallet forks.
    ...
    public static final String GOERLI_RPC_URL = usesProductionKey ? "https://goerli.infura.io/v3/" + keyProvider.getInfuraKey()
            : FREE_GOERLI_RPC_URL;
    public static final String POLYGON_RPC_URL = "http://52.76.47.93:8545"; //"https://polygon-mainnet.infura.io/v3/" + keyProvider.getInfuraKey()
    ...
    //Note that RamesttaWallet  now uses a double node configuration. See class AWHttpService comment 'try primary node'.
    ...
    public static final String POLYGON_FALLBACK_RPC_URL = "http://13.234.27.42:8545";
